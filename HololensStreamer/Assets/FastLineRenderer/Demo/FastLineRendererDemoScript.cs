...
namespace DigitalRuby.FastLineRenderer
{
    ...
    public class FastLineRendererDemoScript : MonoBehaviour
    {
        ...
        private void DoGrid()
        {
            ...
            gridBounds.SetMinMax(new Vector3(-220.0f, -100.0f, 100.0f), new Vector3(-200.0f, 100.0f, 300.0f));
            LineRenderer.AppendGrid(props, gridBounds, 250, false);

            // draw a grid cube with filling
            gridBounds.SetMinMax(new Vector3(20.0f, -100.0f, 100.0f), new Vector3(220.0f, 100.0f, 300.0f));
