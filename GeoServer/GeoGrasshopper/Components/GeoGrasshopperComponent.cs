...
namespace GeoGrasshopper
{
    public class GeoGrasshopperComponent : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddParameter(new StreamSettingsParameter(), "Settings", "S", "Material and other Settings", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData(5, ref settingsGH);

    
          StreamSettings  settings = settingsGH?.Value;
            ...
            if (curves != null && curves.Count != 0)
            {
                ...
                Send.Curves(curves, settings, client);
            }
        }
